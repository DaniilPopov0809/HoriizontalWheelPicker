...
export function HorizontalTimePicker({ 
  ...
  useEffect(() => {
    ...
    const handlePointerUp = () => {
      setTimeout(() => {
        const nearestMultiple = findNearestMultipleOf10(selectedValue, scrollDirection)
  ...
  }, [emblaApi, seconds, onValueChange, selectedValue, scrollDirection, lastScrollProgress])
  ...
  return (
    <div className={cn("w-full", className)}>
      ...
      <div className="relative">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 rounded-lg border-2 border-blue-500/50"
          style={{ 
            width: '3rem', 
            height: '4rem',
          }}
                ...
                >
                  <div 
                    className={cn(
                      ...
                      isSelected 
                        ? "bg-gradient-to-b from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 shadow-lg" 
                        : "bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800/30 dark:to-gray-700/30"
                    )}
                    style={{
